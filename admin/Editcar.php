					...
					<div class="row clearfix">
						<div class="row clearfix">
							...
							if(isset($_GET["searchByCatName"])){
								...
								$sql="SELECT vehicle.*, catagory.name as catname FROM `vehicle` INNER JOIN catagory ON catagory.ID=vehicle.catagory WHERE vehicle.`status` =0 AND vehicle.type='Car'";
							}
