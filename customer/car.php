			...
			<aside>
				<div class="col-md-3 col-sm-12 col-xs-12 sidebar pull-right">
					...
					<div class="widget mb30">
						...
						<ul class="icons-list">
						<?php  
							$sql1="SELECT * FROM `catagory` WHERE type ='Car'";
					...
					<div class="row clearfix">
						<div class="row clearfix">
							...
							if(isset($_GET["searchByCatName"])){
								...
								$sql="SELECT vehicle.*, catagory.name as catname FROM `vehicle` INNER JOIN catagory ON catagory.ID=vehicle.catagory WHERE catagory.name='$catName' AND vehicle.type='Car' AND vehicle.`status` =0 ";
							 
							}else{
								$sql="SELECT vehicle.*, catagory.name as catname FROM `vehicle` INNER JOIN catagory ON catagory.ID=vehicle.catagory WHERE  vehicle.type='Car' AND vehicle.`status` =0 ";
							}
