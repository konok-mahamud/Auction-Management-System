...
if(isset($_GET["cost"])){
	...
	if($con->query($sql)){
		...
		$content="Thank you for confirming your delivery choice. We will deliver the car on ".$setdate.". You can give money on bank. <br> <h3>Bank Information </h3> <br> ACC name: Sheikh parvez mahamud <br> Acc no: 255.105.7696 <br> Bank name: Dutch Bangla Bank <br> <br> For more information you can contact us via mobile or email. Thank you once again.";
