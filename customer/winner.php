...
<div class="container" style="min-height: 500px;">
	<div class="row">
		<div style=" margin-top: 60px;" id="heading">
			...
			<h4 style="text-align: center;">Winning Price: <?=$bidprice?> BDT</h4>
		...
		<div >
			...
			<div style="text-align: justify;">
				...
				<strong>Bidders from the Bangladesh: The only accepted payment methods for bidders are Wire Transfer and hand cash during delivery. We currently accept hand cash up to BDT 5,00,000. All payments BDT 5,00,000 or more must be made via Wire Transfer. </strong>
				...
				<p> 
				AuctionBD currently does not accept international credit cards, credit cards or PayPal based outside of the Bangladesh, as a form of payment.</p>
				...
				<div style="float: right;"  >
					     <div class="col-sm-12  ">
                                <ul style="font-size: 20px;">
                                    <li>
                                       <span>Delivery cost: <label id="deliveryCost" > </label> BDT</span>
                                         
                                         
                                    </li> 
                                  
                                    <li>
                                        <span>Bidding cost:<label id="biddingCost"> <?=$bidprice?>  </label>  BDT </span>
                                    
                                    </li>
                                    <li>
                                        <span style="display: none;" id="mainCheck">Deposit amount (-):<label id="depositCost"> <?=$amount?>  </label>  BDT </span>
                                    	<input type="hidden" id="checking" value="">
                                    </li>
                                    <hr>
                                    <li class="divider"></li>
                                    <li class="total-price">
                                     <span>Total cost: 	&nbsp; <label id="TotalCost" >  </label>  BDT</span>
		...
		<div style="display: block;position: inherit;margin-top: 5%; margin-bottom: 5%;">
				<div>
					...
					Storage rates quoted are effective only for purchased vehicles through the date of pick up or ownership transfer. The storage facility sets all other fees at their sole discretion. 500 BDT will be charged as storage rate per day.
			<h3 style="text-decoration: underline;">Buyers Responsibility:</h3>
				<p>
					<strong>The BUYER will receive an email notification from AuctionBD following the close of an auction.</strong> After fraud verification and payment settlement, we will email the BUYER instructions for retrieving the ASSET from the Will-Call Location listed above.
					<br>
					All applicable shipping, logistics, transportation, customs, fees (storage/gate/title/registration/smog/other), taxes, export/import activities and all associated costs are the sole responsibility of the BUYER. No shipping, customs, export or import assistance is available from AuctionBD.
					<br>
