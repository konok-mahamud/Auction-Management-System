     <!-- Start Suvbscribe -->
            <div class="news-subscribe">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <h3>subscribe to <strong>AuctionBD</strong></h3>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12" style="float: right;">
                            <div class="widget">
                                ...
                                <address>
                                    <p>12/2 Panthopath, Dhanmondi,
                                        Dhaka, Bangladesh</p><br>
                                    <p>Phone: (+88) 01962586387</p>
                                    <p>Fax: (+123) 12-345-6789</p>
                                    <p>E-mail: <a href="mailto:konokmahamud@gmail.com">konokmahamud@gmail.com</a></p>
                                </address>
                            </div>
                        </div>
                        <!-- END CONTACT WIDGET -->
                    ...
                    <div class="copyright">
                        <div class="text-center">
                            <p>© All Rights Reserved @  <a target="_blank" href="">Konok Mahamud</a></p>
                        </div>
                    </div>
