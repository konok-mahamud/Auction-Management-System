...
<body>
           <!-- Header -->
            <div class="header header-static">
                        ...
                        <div class="row">
                            ...
                            <div class="spa-search">
                                <form action="<?=$_SESSION["directory"]?>customer/carsearch.php" method="post">
                                    <input type="text" placeholder="search your keyword ..." value="" class="form-control input-group-lg" style="width: 165%" name="Search">
                ...
                <!-- Navbar -->
                <div class="navbar navbar-default mega-menu" role="navigation" style="background-color: antiquewhite;">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse cd-navbar-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       <li><a href="<?=$_SESSION["directory"]?>admin/Editcar.php">Car</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>admin/EditBike.php">Bike</a></li>
                                       <?php }else{  ?>
                                        <li><a href="<?=$_SESSION["directory"]?>customer/car.php">Car</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>customer/bike.php">Bike</a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <!-- End Pages -->
						   ...
						   <?php
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?=$_SESSION["directory"]?>admin/AddVehicle.php">Add vehicle</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>admin/vehicleList.php">Vehicle List</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>admin/vehicleDelivery.php">Vehicle delivery list</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>admin/userlist.php">User list</a></li><li><a href="<?=$_SESSION["directory"]?>admin/deposit.php">Deposit Checking</a></li>
                                    </ul>
                                </li>
									<?php	}  ?>
