...
?>
        ...
        <div class="wrapper">
                ...
                <div  id="mega-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active beactive">
                            <img src="img/brand/brand1.jpg" alt="..." style="width: 100%; height: 20%;">
                            <div class="carousel-caption">
                                <h2>Welcome to AuctionBD</h2>
                               
                            </div>
                        </div>
                        <div class="item">
                            <img src="img/brand/live-024049.jpg" alt="..." style="width: 100%; height: 20%;">
                            <div class="carousel-caption">
                                <h2>All kinds of Car</h2>
                                 
                            </div>
                        </div>
                        <div class="item">
                            <img src="img/brand/brand3.jpg" alt="..." style="width: 100%; height: 20%;">
                            <div class="carousel-caption">
                                <h2>BID The Vehicle</h2>
            ...
            <section class="home-main-contant-style2 dip-bg-style dip-style bg-white">
                <div class="container">  
                    <div class="widget">
                        <h6 class="text-uppercase bottom-line">New Vehicles</h6>
                    </div>
                    <div class="row">
                        <div class="new-product slider">
                           <?php
								...
								$sql="SELECT vehicle.*, catagory.name as catname FROM `vehicle` INNER JOIN catagory ON catagory.ID=vehicle.catagory WHERE vehicle.`status` =0 ORDER BY `vehicle`.`ID` DESC";
                            ...
                            <div class="col-md-4 item">
                                <div class="products grid-product">
									...
									$bidPrice=$row["MAX(price)"];
											...
											?>
											<h5>Bid Price:<strong><?=$bidPrice?></strong> Taka</h5>
						  ...
						  $result3 = $con->query( $sql3 );
								if ( $result3->num_rows > 0 ) {
									...
									foreach ( $result3 as $row ) {
										...
										$sql="SELECT vehicle.*, catagory.name as catname FROM `vehicle` INNER JOIN catagory ON catagory.ID=vehicle.catagory WHERE vehicle.`status` =0 AND vehicle.ID= '$VeID' ORDER BY `vehicle`.`ID` DESC";
                                ...
                                <div class="products grid-product">
                                    <div class="product-grid-inner">
										...
										<div class="product-grid-caption text-center">
											...
											<h5>Bid Price:<strong><?=$maxprice?></strong> Taka</h5>
											<div class="pro-size"><label>Type: <span><?=$type?></span> </label>
											<div><label>Catagory: <span><?=$catagory?></span> </label></div>
											</div>
                ...
                <div  class="parallax-block parallaxBg">
                    <div class="container">
                        <div class="parallax-block-text">
                            <p>We are gleeful. <span class="color-green">Thanks for checking out our profile.</span> <br>  Thank you! </p>
                        </div>
